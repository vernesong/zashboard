<template>
  ...
  <div class="card">
    ...
    <div
      :class="[
        'card-body grid grid-cols-1 gap-2 lg:grid-cols-2',
        showIPAndConnectionInfo ? 'xl:grid-cols-3' : '2xl:grid-cols-4',
      ]"
    >
...
import { showIPAndConnectionInfo } from '@renderer/store/settings'
